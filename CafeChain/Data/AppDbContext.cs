...
namespace CafeChain.Data
{
    ...
    {   
        ...
        public DbSet<PurchaseAdviceFulfillmentPosting> PurchaseAdviceFulfillmentPostings { get; set; }
        ...
        public DbSet<PurchaseOrderBatchDocumentRevision> PurchaseOrderBatchDocumentRevisions { get; set; }
