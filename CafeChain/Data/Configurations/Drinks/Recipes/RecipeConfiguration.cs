...
namespace CafeChain.Data.Configurations.Drinks.Recipes
{
    public class RecipeConfiguration : IEntityTypeConfiguration<Recipe>
    {
        public void Configure(EntityTypeBuilder<Recipe> entity)
        {
            ...
            entity.HasData(
                new Recipe { RecipeId = 1, RecipeCode = "RCP_CF_SUA", Name = "Recipe CF Sữa", Active = true, Status = "Active", DrinkId = 1 },
                new Recipe { RecipeId = 2, RecipeCode = "RCP_CF_DEN", Name = "Recipe CF Đen", Active = true, Status = "Active", DrinkId = 2 },
                new Recipe { RecipeId = 3, RecipeCode = "RCP_TS", Name = "Recipe Trà sữa", Active = true, Status = "Active", DrinkId = 3 },
                new Recipe { RecipeId = 4, RecipeCode = "RCP_TS_SOCOLA", Name = "Recipe Trà sữa socola", Active = true, Status = "Active", DrinkId = 4 },
