        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_RequestDeduplication_Status", "[Status] IN ('PENDING', 'SUCCESS', 'FAILED')");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TotalExportQty = table.Column<decimal>(type: "decimal(18,3)", nullable: false, defaultValue: 0m),
                    TotalReceivedQty = table.Column<decimal>(type: "decimal(18,3)", nullable: false, defaultValue: 0m),
                    Status = table.Column<int>(type: "int", nullable: false),
                    CreatedAt = table.Column<DateTime>(type: "datetime2", nullable: false, defaultValueSql: "GETDATE()")
                },
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_InventoryTransfer_Received_NotGreater_Export", "[TotalReceivedQty] <= [TotalExportQty]");
                    table.CheckConstraint("CK_InventoryTransfer_TotalExportQty", "[TotalExportQty] >= 0");
                    table.CheckConstraint("CK_InventoryTransfer_TotalReceivedQty", "[TotalReceivedQty] >= 0");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    InventoryTransferId = table.Column<int>(type: "int", nullable: false),
                    IngredientId = table.Column<int>(type: "int", nullable: false),
                    ExportQuantity = table.Column<decimal>(type: "decimal(18,3)", nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_InventoryTransferDetail_ExportQuantity", "[ExportQuantity] > 0");
                    table.CheckConstraint("CK_InventoryTransferDetail_Received_NotGreater_Export", "[ReceivedQuantity] <= [ExportQuantity]");
                    table.CheckConstraint("CK_InventoryTransferDetail_ReceivedQuantity", "[ReceivedQuantity] >= 0");
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_InventoryTransaction_AfterQty", "[AfterQty] >= 0");
                    table.CheckConstraint("CK_InventoryTransaction_QtyBalance", "[BeforeQty] + [Quantity] = [AfterQty]");
                    table.CheckConstraint("CK_InventoryTransaction_Quantity_NotZero", "[Quantity] <> 0");
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 110, true, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "nvcasang@cafechain.vn", null, "$2a$11$efK2U8lomCM2d.8RIBAJpOsC3kqnEphxxGQvt2MFWwgTiDX3MIGAe", true },
                    ...
                    { 123, true, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "nvcachieu@gmail.com", null, "$2a$11$efK2U8lomCM2d.8RIBAJpOsC3kqnEphxxGQvt2MFWwgTiDX3MIGAe", true }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, "CAFECHAIN50", null, null, null, 50, new DateTime(2026, 7, 20, 13, 52, 6, 815, DateTimeKind.Local).AddTicks(1628), null, 20000m, 100, null, 40000m, new DateTime(2026, 6, 13, 13, 52, 6, 815, DateTimeKind.Local).AddTicks(1608), null, null },
                    { 2, true, "GIAM10K", null, null, 10000m, null, new DateTime(2026, 7, 5, 13, 52, 6, 815, DateTimeKind.Local).AddTicks(1634), null, null, 500, null, 50000m, new DateTime(2026, 6, 19, 13, 52, 6, 815, DateTimeKind.Local).AddTicks(1633), null, null },
                    { 3, true, "NEWUSER", null, null, null, 20, new DateTime(2026, 8, 19, 13, 52, 6, 815, DateTimeKind.Local).AddTicks(1639), null, 100000m, 1000, null, 0m, new DateTime(2026, 5, 21, 13, 52, 6, 815, DateTimeKind.Local).AddTicks(1639), null, null }
                });
            ...
            migrationBuilder.InsertData(
                table: "Drinks",
                columns: new[] { "DrinkId", "Active", "CalculatedCogs", "CategoryId", "CreatedAt", "Description", "Name", "ProductTypeId" },
                values: new object[,]
                {
                    { 1, true, 0m, 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cà phê pha với sữa đặc.", "Cà phê sữa", 1 },
                    { 2, true, 0m, 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Cà phê pha với nước sôi, không có sữa.", "Cà phê đen", 1 },
                    { 3, true, 0m, 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Trà sữa pha với trân châu đen và đá viên.", "Trà sữa truyền thống", 1 },
                    { 4, true, 0m, 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Trà sữa socola thơm ngon, béo ngậy.", "Trà sữa socola", 1 },
                    { 5, true, 0m, 3, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Sting mát lạnh", "Sting", 2 },
                    { 6, true, 0m, 3, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "Coca-cola mát lạnh", "Coca-cola", 2 }
                });
            ...
            migrationBuilder.InsertData(
                table: "Recipes",
                columns: new[] { "RecipeId", "Active", "DrinkId", "EffectiveDate", "Name", "ParentVersionId", "Status", "ToppingId", "YieldPercentage" },
                values: new object[,]
                {
                    { 5, true, null, null, "Trân châu đen", null, "Active", 1, 100m },
                    { 6, true, null, null, "Trân châu trắng", null, "Active", 2, 100m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, true, 1, null, "Recipe CF Sữa", null, "Active", null, 100m },
                    { 2, true, 2, null, "Recipe CF Đen", null, "Active", null, 100m },
                    { 3, true, 3, null, "Recipe Trà sữa", null, "Active", null, 100m },
                    { 4, true, 4, null, "Recipe Trà sữa socola", null, "Active", null, 100m }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    ...
                    { 11, true, "0901000111", 111 },
                    { 12, true, "0901000112", 112 }
                });
            ...
            migrationBuilder.InsertData(
                ...
                columns: new[] { "StoreInventoryId", "AvailableQty", "IngredientId", "LastUpdated", "RecipeId", "StoreId" },
                values: new object[,]
                {
                    { 1, 100m, 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 1 },
                    { 2, 50m, 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 1 },
                    { 3, 80m, 1, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 2 },
                    { 4, 60m, 2, new DateTime(2025, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, 3 }
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_RequestDeduplications_RequestKey",
                table: "RequestDeduplications",
                column: "RequestKey",
                unique: true);
