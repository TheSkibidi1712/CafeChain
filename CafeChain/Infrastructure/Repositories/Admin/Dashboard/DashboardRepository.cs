...
public sealed class DashboardRepository : IDashboardRepository
{
    ...
    private static WorkforceShiftStatusRow MapWorkforceShiftStatus(DbDataReader r) => new() { StaffShiftId=Int(r,"StaffShiftId"),StaffId=Int(r,"StaffId"),FullName=String(r,"FullName"),StoreId=Int(r,"StoreId"),WorkDate=Date(r,"WorkDate"),ActualCheckIn=NullableDate(r,"ActualCheckIn"),ActualCheckOut=NullableDate(r,"ActualCheckOut"),PayrollHours=NullableDecimal(r,"PayrollHours"),StatusId=Int(r,"StatusId"),StatusCode=String(r,"StatusCode"),IsAdHoc=Bool(r,"IsAdHoc"),DataStatus=String(r,"DataStatus") };
    private static WorkforceHourlyDemandRow MapWorkforceHourlyDemand(DbDataReader r) => new() { HourOfDay=Int(r,"HourOfDay"),TotalOrders=Long(r,"TotalOrders"),NetSales=Decimal(r,"NetSales"),StaffShiftCount=Long(r,"StaffShiftCount"),OrdersPerStaff=Decimal(r,"OrdersPerStaff"),DataStatus=String(r,"DataStatus") };
    private static WorkforceStaffPerformanceRow MapWorkforceStaffPerformance(DbDataReader r) => new() { StaffId=Int(r,"StaffId"),FullName=String(r,"FullName"),StoreId=Int(r,"StoreId"),TotalOrders=Long(r,"TotalOrders"),NetSales=Decimal(r,"NetSales"),PayrollHours=Decimal(r,"PayrollHours"),SalesPerPayrollHour=Decimal(r,"SalesPerPayrollHour"),DataStatus=String(r,"DataStatus") };
