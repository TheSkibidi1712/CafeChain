...
namespace CafeChain.Models.Stores
{
    public class Store
    {
        ...
        public virtual ICollection<StoreMenuItem> StoreMenuItems { get; set; } = new List<StoreMenuItem>();
        public virtual CafeChain.Models.Drinks.PosCatalogState? PosCatalogState { get; set; }
