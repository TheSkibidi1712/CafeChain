...
namespace CafeChain.Application.Services.Attendance
{
    public class AttendanceSecurityService : IAttendanceSecurityService
    {
        ...
        {
            // [CHẶNG 2] Đã gỡ bypass — kiểm tra IP Wi-Fi cửa hàng thực tế
            ...
            // Development Mode: Localhost auto-pass (IIS Express/Kestrel trên cùng máy)
            // IPv6 Loopback (::1) hoặc IPv4 Loopback (127.0.0.1)
