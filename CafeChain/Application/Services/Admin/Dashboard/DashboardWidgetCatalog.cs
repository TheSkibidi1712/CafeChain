...
internal static class DashboardWidgetCatalog
{
    ...
    private static DashboardWidgetDefinition Create(DashboardAnalyticsWidget widget) => widget switch
    {
        ...
        DashboardAnalyticsWidget.InventoryReorderSuggestions => D(widget, DashboardSection.Inventory, "Đề xuất đặt bổ sung", DashboardChartType.HorizontalBar, "ingredientName", "effectiveSuggestedQuantity", "INGREDIENT", false),
    ...
    private static DashboardMetricDefinition Metric(
        ...
        widget switch
        {
            ...
            DashboardAnalyticsWidget.PaymentMethodMix => M("PaymentRevenue", unit, valueField, dimensionField, sample: "totalTransactions", baseline: supportsComparison),
            ...
            DashboardAnalyticsWidget.InventoryReorderSuggestions => M("SuggestedReorderQuantity", unit, valueField, dimensionField),
            ...
            DashboardAnalyticsWidget.TopProducts => M("ProductRevenue", unit, valueField, dimensionField, sample: "totalSold", baseline: supportsComparison),
            ...
            DashboardAnalyticsWidget.CategoryPerformance => M("Revenue", unit, valueField, dimensionField, sample: "totalSold", baseline: supportsComparison),
