...
public sealed class WorkShiftOptions
{
    ...
    public int LateScheduledApprovalMaxMinutes { get; set; } = 45;
    ...
    public int ResolveLateScheduledApprovalMaxMinutes() =>
        Math.Max(LateApprovalAfterMinutes, LateScheduledApprovalMaxMinutes);
