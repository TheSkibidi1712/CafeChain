...
public class DashboardFilterDto
{
    ...
    [System.Text.Json.Serialization.JsonIgnore] public DateTime? PeriodStartOverride { get; set; }
    [System.Text.Json.Serialization.JsonIgnore] public DateTime? PeriodEndOverride { get; set; }
    [System.Text.Json.Serialization.JsonIgnore] public IReadOnlyList<int>? StoreIdsOverride { get; set; }
}

public sealed class DashboardContextRequestDto : DashboardFilterDto
{
    public Guid? ContextId { get; set; }
    public DashboardPeriodPreset? Preset { get; set; }
}
...
public sealed class DashboardAnalysisContextDto
{
    public Guid ContextId { get; set; }
    ...
    public DashboardPeriodPreset? Preset { get; set; }
    public string PeriodType { get; set; } = "Custom";
    public DateTimeOffset? ComparisonStart { get; set; }
    public DateTimeOffset? ComparisonEnd { get; set; }
    public int? StoreId { get; set; }
    ...
    public IReadOnlyDictionary<string, object> Sections { get; set; } =
        new Dictionary<string, object>(StringComparer.OrdinalIgnoreCase);
}

public sealed class DashboardWidgetMetadataDto
{
...
public sealed class ExecutiveDashboardData
{
    ...
    public DashboardWidgetResult<OrderStatusSummaryRow> OrderStatusSummary { get; set; } = new();
}
...
public sealed class InventoryDashboardData
{
    ...
    public DashboardWidgetResult<IngredientConsumptionTrendRow> IngredientConsumptionTrend { get; set; } = new();
}
...
public sealed class DashboardSectionTelemetryDto
{
    public string Period { get; set; } = "Current";
    public DashboardSection Section { get; set; }
    public long ElapsedMilliseconds { get; set; }
    public int WidgetCount { get; set; }
    public int FailedWidgetCount { get; set; }
}

public sealed class DashboardAnalyticsBatchResponse
{
    public IReadOnlyDictionary<DashboardAnalyticsWidget, DashboardAnalyticsResponse> Widgets { get; set; } =
        new Dictionary<DashboardAnalyticsWidget, DashboardAnalyticsResponse>();
    public IReadOnlyList<DashboardSectionTelemetryDto> Telemetry { get; set; } = [];
}

public sealed class DashboardAnalysisAuditDto
{
    ...
    public int WidgetFailureCount { get; set; }
}
...
public sealed class StoreRankingRow : DashboardRow { public int StoreId { get; set; } public string StoreName { get; set; } = string.Empty; public long TotalOrders { get; set; } public decimal NetSales { get; set; } public decimal AverageOrderValue { get; set; } public int Rank { get; set; } public decimal ContributionPercent { get; set; } }
public sealed class PaymentMethodMixRow : DashboardRow { public int PaymentMethodId { get; set; } public string PaymentMethodCode { get; set; } = string.Empty; public string PaymentMethodName { get; set; } = string.Empty; public long TotalTransactions { get; set; } public decimal Amount { get; set; } public decimal Share { get; set; } public decimal TransactionShare { get; set; } public decimal RevenueShare { get; set; } }
...
public sealed class OperationalAlertRow : DashboardRow { public string AlertType { get; set; } = string.Empty; public int StoreId { get; set; } public string StoreName { get; set; } = string.Empty; public string EntityType { get; set; } = string.Empty; public int EntityId { get; set; } public string EntityCode { get; set; } = string.Empty; public string EntityName { get; set; } = string.Empty; public string Severity { get; set; } = string.Empty; public decimal AlertValue { get; set; } public int AlertCount { get; set; } = 1; public string Unit { get; set; } = string.Empty; public string Message { get; set; } = string.Empty; }
public sealed class OrderStatusSummaryRow : DashboardRow { public int StoreId { get; set; } public string StoreName { get; set; } = string.Empty; public long TotalOrders { get; set; } public long CompletedOrders { get; set; } public long CancelledOrders { get; set; } public decimal CancellationRate { get; set; } }
...
public sealed class OverduePurchaseOrderRow : DashboardRow { public int PurchaseOrderId { get; set; } public string Code { get; set; } = string.Empty; public int StoreId { get; set; } public string StoreName { get; set; } = string.Empty; public int SupplierId { get; set; } public string SupplierName { get; set; } = string.Empty; public string Status { get; set; } = string.Empty; public DateTime OrderDate { get; set; } public DateTime ExpectedDeliveryAtUtc { get; set; } public int OverdueDays { get; set; } public decimal OrderedValue { get; set; } }
...
public sealed class TopProductRow : DashboardRow { public int DrinkId { get; set; } public string DrinkName { get; set; } = string.Empty; public int? CategoryId { get; set; } public string CategoryName { get; set; } = string.Empty; public int TotalSold { get; set; } [JsonPropertyName("netSales")] public decimal ProductRevenue { get; set; } public decimal QuantityShare { get; set; } public decimal RevenueShare { get; set; } public decimal ConfirmedCogs { get; set; } public decimal ConfirmedGrossProfit { get; set; } public decimal ConfirmedMarginRate { get; set; } public decimal ContributionPercent { get; set; } }
...
public sealed class BomHealthRow : DashboardRow { public int DrinkId { get; set; } public string DrinkCode { get; set; } = string.Empty; public string DrinkName { get; set; } = string.Empty; public int RecipeCount { get; set; } public int RecipeLineCount { get; set; } public int InvalidLineCount { get; set; } public int BomIssueCount { get; set; } }
...
public sealed class CategoryPerformanceRow : DashboardRow { public int? CategoryId { get; set; } public string CategoryName { get; set; } = string.Empty; public int TotalSold { get; set; } public decimal Revenue { get; set; } public decimal ConfirmedCogs { get; set; } public decimal ConfirmedGrossProfit { get; set; } public decimal ConfirmedMarginRate { get; set; } public decimal ContributionPercent { get; set; } }
public sealed class ProductPeriodPerformanceRow : DashboardRow { public int DrinkId { get; set; } public string DrinkName { get; set; } = string.Empty; public int TotalSold { get; set; } public decimal Revenue { get; set; } public decimal ConfirmedCogs { get; set; } public decimal ConfirmedGrossProfit { get; set; } public decimal ConfirmedMarginRate { get; set; } public decimal ContributionPercent { get; set; } }

public sealed class WorkforceShiftStatusRow : DashboardRow { public int StaffShiftId { get; set; } public int StaffId { get; set; } public string FullName { get; set; } = string.Empty; public int StoreId { get; set; } public DateTime WorkDate { get; set; } public int ShiftId { get; set; } public string ShiftName { get; set; } = string.Empty; public DateTime PlannedStartAt { get; set; } public DateTime PlannedEndAt { get; set; } public string StatusCode { get; set; } = string.Empty; public bool IsOvernight { get; set; } public int ShiftCount { get; set; } = 1; }
public sealed class WorkforceHourlyDemandRow : DashboardRow { public int HourOfDay { get; set; } public long TotalOrders { get; set; } public long ScheduledStaffCount { get; set; } }
public sealed class WorkforceStaffPerformanceRow : DashboardRow { public int StaffId { get; set; } public string FullName { get; set; } = string.Empty; public int StoreId { get; set; } public long WorkShiftCount { get; set; } public long TotalOrders { get; set; } public decimal NetSales { get; set; } public decimal AverageOrderValue { get; set; } public decimal OrdersPerWorkShift { get; set; } }
