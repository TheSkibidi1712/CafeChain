...
namespace CafeChain.Application.DTOs.Admin.InventoryDocuments.Detail
{
    public class InventoryDocumentDetailDTO
    {
        ...
        public List<InventoryDocumentDetailItemDTO> Details { get; set; } = [];
    }
}
