...
namespace CafeChain.Application.Interfaces.Admin
{
    public interface IAdminOrderService
    {
        ...
        /// </summary>
        Task<List<AdminOrderKanbanDto>> GetKanbanOrdersAsync(int storeId);

        /// <summary>
        /// Lấy chi tiết một đơn hàng dùng cho Offcanvas Panel.
        /// </summary>
        Task<AdminOrderDetailDto> GetOrderDetailsAsync(int orderId, int storeId);
        ...
        /// </summary>
        Task AcceptOrderAsync(int orderId, int storeId);

        /// <summary>
        /// Xong món: Chuyển trạng thái Preparing(4) → WaitingForPickUp(5).
        /// Guard: Chỉ chấp nhận đơn đang ở status 4.
        /// </summary>
        Task ReadyForPickupAsync(int orderId, int storeId);

        /// <summary>
        /// Lấy danh sách nhân viên giao hàng đang Active.
        /// </summary>
        Task<List<ShipperDto>> GetShippersAsync(int storeId);

        /// <summary>
        /// Giao shipper: Chuyển trạng thái Ready(3) → Delivering(4).
        /// </summary>
        Task DispatchOrderAsync(DispatchOrderRequest request, int storeId);
        ...
        /// </summary>
        Task CompleteOrderAsync(int orderId, int storeId);
        ...
        /// </summary>
        Task CancelOrderAsync(int orderId, int storeId, string reason);
        
        /// <summary>
        /// Mô phỏng việc Partner Webhook trả về kết quả thành công cho toàn bộ đơn Đang Giao.
        /// </summary>
        Task<int> SimulateWebhookAsync(int storeId);
        ...
        /// </summary>
        Task<AdminOrderHistoryDetailDto> GetOrderHistoryDetailAsync(int orderId, int storeId);
