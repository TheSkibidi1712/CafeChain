...
namespace CafeChain.Application.Interfaces.Inventories
{
    public interface IPurchaseAdviceService
    {
        ...
        Task<ServiceResult<PurchaseAdviceDetailDto>> AddRestockRequestToDraftAsync(AddRestockRequestToDraftPurchaseAdviceRequest request, AdminActorContext actor);
