...
namespace CafeChain.Data.Configurations.Drinks
{
    ...
    public class DrinkImageConfiguration : IEntityTypeConfiguration<DrinkImage>
    {
        public void Configure(EntityTypeBuilder<DrinkImage> entity)
        {
            ...
            entity.HasData(
                new DrinkImage { DrinkImageId = 1, DrinkId = 1, IsDefault = true, ImageUrl = "/Images/DrinkImages/cps1.jpg", PublicId = "drink-images/cps1", CreatedAt = new DateTime(2025, 1, 1)},
                new DrinkImage { DrinkImageId = 2, DrinkId = 1, IsDefault = false, ImageUrl = "/Images/DrinkImages/cps2.jpg", PublicId = "drink-images/cps2", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 3, DrinkId = 1, IsDefault = false, ImageUrl = "/Images/DrinkImages/cps3.jpg", PublicId = "drink-images/cps3", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 4, DrinkId = 1, IsDefault = false, ImageUrl = "/Images/DrinkImages/cps4.jpg", PublicId = "drink-images/cps4", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 5, DrinkId = 2, IsDefault = true, ImageUrl = "/Images/DrinkImages/cpd1.jpg", PublicId = "drink-images/cpd1", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 6, DrinkId = 2, IsDefault = false, ImageUrl = "/Images/DrinkImages/cpd2.jpg", PublicId = "drink-images/cpd2", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 7, DrinkId = 2, IsDefault = false, ImageUrl = "/Images/DrinkImages/cpd3.jpg", PublicId = "drink-images/cpd3", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 8, DrinkId = 2, IsDefault = false, ImageUrl = "/Images/DrinkImages/cpd4.jpg", PublicId = "drink-images/cpd4", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 9, DrinkId = 3, IsDefault = true, ImageUrl = "/Images/DrinkImages/trasuatranchauden1.jpg", PublicId = "drink-images/trasuatranchauden1", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 10, DrinkId = 3, IsDefault = false, ImageUrl = "/Images/DrinkImages/trasuatranchauden2.jpg", PublicId = "drink-images/trasuatranchauden2", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 11, DrinkId = 3, IsDefault = false, ImageUrl = "/Images/DrinkImages/trasuatranchauden3.jpg", PublicId = "drink-images/trasuatranchauden3", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 12, DrinkId = 3, IsDefault = false, ImageUrl = "/Images/DrinkImages/trasuatranchauden4.jpg", PublicId = "drink-images/trasuatranchauden4", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 13, DrinkId = 4, IsDefault = true, ImageUrl = "/Images/DrinkImages/trasuasocola1.jpg", PublicId = "drink-images/trasuasocola1", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 14, DrinkId = 4, IsDefault = false, ImageUrl = "/Images/DrinkImages/trasuasocola2.jpg", PublicId = "drink-images/trasuasocola2", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 15, DrinkId = 4, IsDefault = false, ImageUrl = "/Images/DrinkImages/trasuasocola3.jpg", PublicId = "drink-images/trasuasocola3", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 16, DrinkId = 4, IsDefault = false, ImageUrl = "/Images/DrinkImages/trasuasocola4.jpg", PublicId = "drink-images/trasuasocola4", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 17, DrinkId = 5, IsDefault = true, ImageUrl = "/Images/DrinkImages/sting1.jpg", PublicId = "drink-images/sting1", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 18, DrinkId = 5, IsDefault = false, ImageUrl = "/Images/DrinkImages/sting2.jpg", PublicId = "drink-images/sting2", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 19, DrinkId = 5, IsDefault = false, ImageUrl = "/Images/DrinkImages/sting3.jpg", PublicId = "drink-images/sting3", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 20, DrinkId = 5, IsDefault = false, ImageUrl = "/Images/DrinkImages/sting4.jpg", PublicId = "drink-images/sting4", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 21, DrinkId = 6, IsDefault = true, ImageUrl = "/Images/DrinkImages/coca1.jpg", PublicId = "drink-images/coca1", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 22, DrinkId = 6, IsDefault = false, ImageUrl = "/Images/DrinkImages/coca2.jpg", PublicId = "drink-images/coca2", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 23, DrinkId = 6, IsDefault = false, ImageUrl = "/Images/DrinkImages/coca3.jpg", PublicId = "drink-images/coca3", CreatedAt = new DateTime(2025, 1, 1) },
                new DrinkImage { DrinkImageId = 24, DrinkId = 6, IsDefault = false, ImageUrl = "/Images/DrinkImages/coca4.jpg", PublicId = "drink-images/coca4", CreatedAt = new DateTime(2025, 1, 1) }
            );
        }
    }
    ...
    public class ToppingConfiguration : IEntityTypeConfiguration<Topping>
    {
        public void Configure(EntityTypeBuilder<Topping> entity)
        {
            ...
            // ================= SEED DATA =================
            entity.HasData(
                new Topping { ToppingId = 1, Name = "Trân châu đen", Price = 5000m, ImageUrl = "/Images/ToppingImages/tranchauden.jpg", ImagePublicId = "tranchauden", Active = true },
                new Topping { ToppingId = 2, Name = "Trân châu trắng", Price = 5000m, ImageUrl = "/Images/ToppingImages/tranchautrang.jpg", ImagePublicId = "tranchautrang", Active = true },
                new Topping { ToppingId = 3, Name = "Phô mai viên", Price = 7000m, ImageUrl = "/Images/ToppingImages/phomaivien.jpg", ImagePublicId = "phomaivien", Active = true },
                new Topping { ToppingId = 4, Name = "Khúc bạch chân mèo", Price = 7000m, ImageUrl = "/Images/ToppingImages/khucbachchanmeo.jpg", ImagePublicId = "khucbachchanmeo", Active = true },
                new Topping { ToppingId = 5, Name = "Thạch khoai môn", Price = 6000m, ImageUrl = "/Images/ToppingImages/thachkhoaimon.jpg", ImagePublicId = "thachkhoaimon", Active = true },
                new Topping { ToppingId = 6, Name = "Bánh flan", Price = 6000m, ImageUrl = "/Images/ToppingImages/banhflan.jpg", ImagePublicId = "banhflan", Active = true }
            );
        }
    }
    ...
    public class RecipeConfiguration : IEntityTypeConfiguration<Recipe>
    {
        public void Configure(EntityTypeBuilder<Recipe> entity)
        {
            ...
            entity.HasData(
                new Recipe { RecipeId = 1, Name = "Recipe CF Sữa", Active = true, Status = "Active", DrinkId = 1 },
                new Recipe { RecipeId = 2, Name = "Recipe CF Đen", Active = true, Status = "Active", DrinkId = 2 },
                new Recipe { RecipeId = 3, Name = "Recipe Trà sữa", Active = true, Status = "Active", DrinkId = 3 },
                new Recipe { RecipeId = 4, Name = "Recipe Trà sữa socola", Active = true, Status = "Active", DrinkId = 4 },
                new Recipe { RecipeId = 5, Name = "Trân châu đen", Active = true, Status = "Active", ToppingId = 1 },
                new Recipe { RecipeId = 6, Name = "Trân châu trắng", Active = true, Status = "Active", ToppingId = 2 }
            );
        }
    }
